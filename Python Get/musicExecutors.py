...
# url = 'https://anytexteditor.com/ru/group-name-generator' #генератор имен групп
url = 'https://anytexteditor.com/ru/xbox-name-generator' #генератор имен xbox
...
with open('executors.txt', 'w') as f :
    for i in range(max) :
        # driver.execute_script("document.getElementsByClassName('anytext-button')[0].click()")
